...
#adjusting that only the surname of a player is presented. Note that it works for English women sides, if you decide to work with Spanish names, some modifications would be needed 
...
#plotting passes between players
